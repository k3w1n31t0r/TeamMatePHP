  ...
  <div class="content-wrapper">
    ...
    <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#historial" data-toggle="tab">Actividades</a></li>
   ...
   <div class="tab-pane" id="historial">  
     <ul class="timeline">
              <!-- timeline time label --> 
               <?php
                $idTicket=$_GET['id'];
                $resultadoSeg=selectSeguimiento($idTicket);
                while ($renglonSeg=mysqli_fetch_array($resultadoSeg)){                                                
                ?>
                  <li class="time-label">
                   <span class="bg-light-blue"><?php echo $renglonSeg['sub_date']; ?></span>
                  </li>
              <!-- /.timeline-label -->
              <!-- timeline item -->
                <li>
              <!-- timeline icon -->
               ...
               <div class="timeline-item">
                 <span class="time"><i class="fa fa-clock-o"></i> <?php echo $renglonSeg['time'];?> </span>

                   <h3 class="timeline-header"><a href="#"><?php echo $renglonSeg['user_id_id']; ?></a> ...</h3>
                   <div class="timeline-body"><?php echo $renglonSeg['descrip']; ?></div>
              <div class="timeline-footer">               
            </div>
        </div>
      </li>
    ...
    <form id="frmajax2" role="form" method="post" action="#historial">
              <div class="box-body">
                  <div class="form-group col-xs-6">
                    ...
                    <div class="form-group col-xs-12">
                       <label>Escribe una descripción</label>
                        <textarea class="form-control" rows="3" name="desSeguimiento" placeholder="Descripción ... Actividades"></textarea>
                        <div class="box-footer">
                          <button class="btn btn-primary" id="btnguardar2">Guardar</button>
                        </div>
                    </div>
              </div>
     </form>
  ...
  $(document).ready(function(){
   ...
   $(document).ready(function(){
    $('#btnguardar2').click(function(){
      ...
      $.ajax({
        type:"POST",
        url:"funciones/crearSeguimiento.php",
        data:datos,
        success:function(r){
         return false;
        }
...
case 3:
  //case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente
//case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente
//case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente//case 3 case 3 case3 o de agente
  require('funciones/funciones.php');
?>
            ...
            <form role="form" method="post" action="funciones/actualizarSeguimiento.php">
              <div class="box-body">
                ...
                <div class="form-group col-xs-3">
                 ...
                 <div class="form-group col-xs-3">
                  <label for="agente">Agente</label>
                    <select class="form-control select2" multiple="multiple" name="agentes[]"  disabled data-placeholder="Selecciona agentes"
                        style="width: 100%;">
                      <?php
                          $resultado2=selectAgente();
                           while ($renglon=mysqli_fetch_array($resultado2)){
        ...
        <form id="frmajax" role="form" method="post">
              <div class="box-body">
                <div class="form-group col-xs-6">
                    ...
                    <div class="form-group col-xs-12">
                          <label>Escribe una descripción</label>
                           <textarea class="form-control" rows="3" placeholder="Descripción ... Seguimiento" name="desActividad"></textarea>
                          <div class="box-footer">
                              <button class="btn btn-primary" id="btnguardar">Guardar</button>
                          </div>
                    </div>    
