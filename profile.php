...
<head>
  ...
  <title>TeamMate | Perfil de usuario</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li class="active treeview menu-open">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="profile.php"><i class="fa fa-circle-o"></i>Perfil</a></li>
          </ul>
        </li>
       </ul>
    </section>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <p class="text-muted text-center">Equipo</p>
  <!--            <a href="#" class="btn btn-primary btn-block"><b>(otra opcion)</b></a>-->
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->    
...
<!--                  <div class="form-group">
                  <label for="inputTipo" class="col-sm-2 control-label">Tipo de usuario</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Equipo</label>

                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputName" placeholder="Equipo">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputSkills" placeholder="Puesto">
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="contrasenia2" class="col-sm-2 control-label">Contraseña</label>

                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="contrasenia2" placeholder="Contraseña">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="exampleInputFile"  class="col-sm-2 control-label" >Fotografia de perfil</label>
                      <div class="col-sm-10">
